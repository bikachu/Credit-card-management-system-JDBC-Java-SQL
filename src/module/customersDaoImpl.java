...
//author: Peter Li
    ...
    public void modifyAddress(String apt_no,String street_name, String cust_city, String cust_state, String cust_zip, int ssn) throws SQLException{
        ...
        String sql = String.format(MyQuery.modifyAddress,apt_no,street_name,cust_city,cust_state,cust_zip,ssn);
        String sql2 = String.format(MyQuery.ssnResult,ssn);
        ...
        myRs.next();
        System.out.println("Your updated Address is:  " +
                    myRs.getString("apt_no") + " " + myRs.getString("street_name") + " " +
                    myRs.getString("cust_city") + " " + myRs.getString("cust_state") + " " +
                    myRs.getString("cust_country") + " " + myRs.getString("cust_zip") + " "+
                    myRs.getTimestamp("last_updated"));
    ...
    public void modifyName(String first_name, String middle_name, String last_name, int ssn) throws SQLException{
        ...
        String sql = String.format(MyQuery.modifyName,first_name,middle_name,last_name,ssn);
        String sql2 = String.format(MyQuery.ssnResult,ssn);
        ...
        myRs.next();
        System.out.println("Your updated Name is:  " + myRs.getString("first_name") + " " +
                myRs.getString("middle_name") + " " + myRs.getString("last_name") + " " +
                myRs.getInt("ssn") + " " + myRs.getTimestamp("last_updated"));
    ...
    public void modifyPhone(int cust_phone, int ssn) throws SQLException{
        ...
        String sql = String.format(MyQuery.modifyPhone,cust_phone,ssn);
        String sql2 = String.format(MyQuery.ssnResult,ssn);
        ...
        myRs.next();
        System.out.println("Your updated Phone Number is:  " +
                myRs.getInt("cust_phone") + " "+ myRs.getTimestamp("last_updated"));
    ...
    public void modifyEmail(String cust_email, int ssn) throws SQLException{
        ...
        String sql = String.format(MyQuery.modifyEmail,cust_email,ssn);
        String sql2 = String.format(MyQuery.ssnResult,ssn);
        ...
        myRs.next();
        System.out.println("Your updated Email Address is:  " +
                myRs.getString("cust_email") + " " + myRs.getTimestamp("last_updated"));
